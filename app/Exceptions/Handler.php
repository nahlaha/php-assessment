...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Throwable $exception)
    {
        ...
        if ($exception instanceof ValidationException) {
            return $responseService->getErrorResponse($exception->getCode(), $exception->getHttpCode(), $exception->getValidationErrors());
        }
        if ($exception instanceof BaseException) {
            return $responseService->getErrorResponse($exception->getCode(), $exception->getHttpCode());
        }
